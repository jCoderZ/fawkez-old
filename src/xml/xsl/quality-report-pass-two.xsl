            ...
            <table frame="all">
               ...
               <tgroup cols="2" align="left" colsep="1" rowsep="1">
                  ...
                  <tbody>
                     ...
                     <xsl:variable name="number_executed_testspecs" select="count(//tc:test[key('testresult-testcase-group',tc:id)/tr:testcase = tc:id or key('testresult-shortname-group',tc:shortname)/tr:shortname = tc:shortname])"/>
                     <xsl:variable name="number_executed_testspecs_passed" select="count(//tc:test[key('testresult-testcase-group',tc:id)[tr:result = 'passed']/tr:testcase = tc:id or key('testresult-shortname-group',tc:shortname)[tr:result = 'passed']/tr:shortname = tc:shortname])"/>
